...
```
    ...
    ## [1] "no of genes before filtering... 38629"
    ## [1] "no of genes after filtering... 18093"

``` r
dds.ensg <- filter_out_low_expressed(dds.ensg)
```

    ## [1] "no of genes before filtering... 58682"
    ## [1] "no of genes after filtering... 21850"
...
![](02_QC_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
```
    ...
    ##  [4] "B86T24"              "B103T104"            "B103T105"           
    ##  [7] "B103T52"             "B103T53"             "B103T65"            
    ## [10] "B123U4"              "CAF_Culture_D220T21"

``` r
paste(outliers, collapse = "|")
```

    ## [1] "B86T3|B86T16|B86T22|B86T24|B103T104|B103T105|B103T52|B103T53|B103T65|B123U4|CAF_Culture_D220T21"
...
```
    ...
    ## [1] "writing reduced metadata file to ../intermediate_files/metadata_outliers_removed_hgnc_2022-10-17.txt"
...
```
    ...
    ## [1] "writing reduced metadata file to ../intermediate_files/metadata_outliers_removed_ensembl_gene_id_version_2022-10-17.txt"
...
```
    ...
    ## [1] "writing batch corrected data to ../intermediate_files/dds_batch_corrected_group_tumor_hgnc_2022-10-17.Rds"
...
```
    ...
    ## [1] "writing batch corrected data to ../intermediate_files/dds_batch_corrected_group_tumor_ensembl_gene_id_version_2022-10-17.Rds"
...
![](02_QC_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

From the above we can see that when we include surrogate variables, we
lose our biological signal.
...
![](02_QC_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](02_QC_files/figure-gfm/unnamed-chunk-16-3.png)<!-- -->
...
```
    ...
    ##      SV         pval        padj sig
    ## 1   SV1 0.2608464277 0.779688066  No
    ## 2   SV2 0.0842694505 0.463481978  No
    ## 3   SV3 0.7577974010 0.822026703  No
    ## 4   SV4 0.0423102503 0.310275169  No
    ## 5   SV5 0.5414760975 0.779688066  No
    ## 6   SV6 0.0007722487 0.008494736 Yes
    ## 7   SV7 0.4588559881 0.779688066  No
    ## 8   SV8 0.0002899309 0.006378480 Yes
    ## 9   SV9 0.7432938617 0.822026703  No
    ## 10 SV10 0.3703404983 0.779688066  No
    ## 11 SV11 0.2884556383 0.779688066  No
    ## 12 SV12 0.5670458663 0.779688066  No
    ## 13 SV13 0.3073176736 0.779688066  No
    ## 14 SV14 0.3440165371 0.779688066  No
    ## 15 SV15 0.4221973829 0.779688066  No
    ## 16 SV16 0.7672826154 0.822026703  No
    ## 17 SV17 0.5134607516 0.779688066  No
    ## 18 SV18 0.2175984030 0.779688066  No
    ## 19 SV19 0.7846618532 0.822026703  No
    ## 20 SV20 0.5095399953 0.779688066  No
    ## 21 SV21 0.7621855547 0.822026703  No
    ## 22 SV22 0.9159460266 0.915946027  No
...
![](02_QC_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
