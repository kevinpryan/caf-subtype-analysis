...
```
    ...
    ## [1] "writing reduced metadata file to ../intermediate_files/metadata_outliers_removed_hgnc_2022-10-10.txt"
...
```
    ...
    ## [1] "writing reduced metadata file to ../intermediate_files/metadata_outliers_removed_ensembl_gene_id_version_2022-10-10.txt"
...
```
    ...
    ## [1] "writing batch corrected data to ../intermediate_files/dds_batch_corrected_group_tumor_hgnc_2022-10-10.Rds"
...
```
    ...
    ## [1] "writing batch corrected data to ../intermediate_files/dds_batch_corrected_group_tumor_ensembl_gene_id_version_2022-10-10.Rds"
