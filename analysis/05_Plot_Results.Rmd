...
```{r}
cibersort_plot_online_abs <- cibersort_plot_online_abs + theme(axis.text.x=element_text(angle=60, hjust=1))
...
outfile.plot.name.compare.tan.caf <- "outfiles/compare_tan_caf_proporions.svg"
#ggsave(filename = here(outfile.plot.name.compare.tan.caf), plot = proportion_per_subpop_caf_tan_plot, width = 10, height = 7, dpi = 320, device = "svg")
