...
peigencor_no_inhouse <- eigencorplot(p,
    ...
    corUSE = 'pairwise.complete.obs',
    corMultipleTestCorrection = 'none',
    main = 'PC1-10 clinical correlations without In-House',
    colFrame = 'white',
    plotRsquared = TRUE)
```
```{r}
...
peigencor_reduced <- eigencorplot(p,
    ...
    corUSE = 'pairwise.complete.obs',
    corMultipleTestCorrection = 'none',
    main = 'PC1-10 clinical correlations remove outlier',
    colFrame = 'white',
    plotRsquared = TRUE)
...
ppairs_no_6144 <- pairsplot(p, components = getComponents(p, c(1:3)),
    triangle = TRUE, trianglelabSize = 12,
    hline = 0, vline = 0,
    pointSize = 0.8, gridlines.major = FALSE, gridlines.minor = FALSE,
    #colby = 'Strandedness',
...
ppairs_no_6144_colour_subpop <- pairsplot(p, components = getComponents(p, c(1:3)),
    triangle = TRUE, trianglelabSize = 12,
    hline = 0, vline = 0,
    pointSize = 0.8, gridlines.major = FALSE, gridlines.minor = FALSE,
    #colby = 'Strandedness',
