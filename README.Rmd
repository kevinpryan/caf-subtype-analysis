...
cibersort_plot_online <- ggplot(cibersort_results_long_online, aes(x = as.character(Mixture), y = value, fill = `Subpopulation`)) + 
  geom_col() + 
  ggtitle("Online") +   
  theme(plot.title = element_text(hjust = 0.5))
...
```{r, include = FALSE}
cibersort_grid <- plot_grid(cibersort_plot_online, cibersort_plot_docker,
      ncol = 2,
      labels = c('A', 'B'),
      label_fontfamily = 'serif',
      label_fontface = 'bold',
      label_size = 15,
      align = 'h')
ggsave(filename = "/home/kevin/Documents/PhD/rna_seq_bc/images_for_presentation/cibersort_plot.png", plot = cibersort_grid)
```
