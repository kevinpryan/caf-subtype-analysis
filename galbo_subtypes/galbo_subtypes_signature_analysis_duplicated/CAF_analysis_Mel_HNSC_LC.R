...
saveRDS(GSE72056_melanoma_cafs_resolution_0.5, file = "~/Documents/PhD/subtypes/caf-subtype-analysis/galbo_subtypes/data/outputs/GSE72056_melanoma_cafs_resolution.Rds")
...
saveRDS(GSE103322_hnsc_cafs_resolution_0.3, file = "~/Documents/PhD/subtypes/caf-subtype-analysis/galbo_subtypes/data/outputs/GSE103322_hnsc_cafs_resolution_0.3_hnsc.Rds")
#E-MTB_6149 (LC)
...
LC_cafs.markers_top20 <- LC_cafs.markers %>% dplyr::group_by(cluster) %>% top_n(n = 20, wt = avg_logFC)
...
saveRDS(LC_cafs, file = "~/Documents/PhD/subtypes/caf-subtype-analysis/galbo_subtypes/data/outputs/LC_cafs.Rds")
...
LC_cafs.markers2 %>% group_by(cluster) %>% top_n(n = 2, wt = avg_logFC)
LC_cafs.markers_top20_2 <- LC_cafs.markers2 %>% dplyr::group_by(cluster) %>% top_n(n = 20, wt = avg_logFC)
...
saveRDS(LC_cafs_2, file = "~/Documents/PhD/subtypes/caf-subtype-analysis/galbo_subtypes/data/outputs/LC_cafs_2.Rds")
